        ...
        <div className={styles.datos}>
          ...
          {datosSalud.surgeryRad === "Si" ? (
            <div className={styles.segmentos}>
              ...
              <h4>Diagnostico:{datosSalud.surgeryDiagnosis}</h4>
          ...
          {datosSalud.prosthesisRad === "Si" ? (
            <div className={styles.segmentos}>
              ...
              <h4>Fecha de Colocacion: {datosSalud.prosthesisDate}</h4>
              <h4>Tipo: {datosSalud.typeProsthesis}</h4>
            </div>
          ) : null}
          {datosSalud.psychiatricRad === "Si" ? (
            <h4>Posee antecedentes de enfermedades Psiquiatricas</h4>
          ) : null}
          {datosSalud.psychActuallyRad === "Si" ? (
            <div className={styles.segmentos}>
              ...
              <h4>Internaciones:{datosSalud.psychhospitalization}</h4>
              <h4>Fecha: {datosSalud.psychhospitalizationDate}</h4>
            </div>
          ) : null}
          {datosSalud.hospitalizationRad === "Si" ? (
            <div className={styles.segmentos}>
              <h4>Internaciones clinicas</h4>
              <h4>Motivo: {datosSalud.hospitalizationReason}</h4>
              <h4>Fecha: {datosSalud.hospitalizationDate}</h4>
            </div>
          ) : null}
          {datosSalud.otherTreatmentsRad === "Si" ? (
            <div className={styles.segmentos}>
              <h4>Tratamientos actuales: {datosSalud.otherT}</h4>
              <h4>Diagnostico:{datosSalud.otherTDiagnosis}</h4>
              <h4>Medico Tratante:{datosSalud.otherTMedic}</h4>
              <h4>Telefono: {datosSalud.otherTNumber}</h4>
            </div>
          ) : null}
          <h4>
            Ultima fecha de estudios-analisis: {datosSalud.medicalStudiesDate}
          </h4>
          {datosSalud.medicalResultsRad === "No" ? (
            <div className={styles.segmentos}>
              <h4>Diagnostico: {datosSalud.studiesDiagnostic}</h4>
            </div>
          ) : null}
          ...
          {datosSalud.studiesSixMonthsRad === "Si" ? (
            <div className={styles.segmentos}>
              <h4>
                requiere atencion en los proximos 6 meses por:
          ...
          {datosSalud.visionHearingRad === "Si" ? (
            <div className={styles.segmentos}>
              <h4>Dificultades de Vision/Audicion: {datosSalud.VHDetail}</h4>
          ...
          {datosSalud.diabetesRad === "Si" ? (
            <div className={styles.segmentos}>
              <h4>
                {" "}
                presenta o ha presentado alguna de las siguientes patologias
          ...
          {datosSalud.otherDiabetesRad === "Si" ? (
            <div className={styles.segmentos}>
              <h4>
                Presenta la siguiente patologia:{datosSalud.otherDiabetes}
              </h4>
            </div>
          ) : null}
          {datosSalud.adictionsRad === "Si" ? (
            <div className={styles.segmentos}>
              <h4>Presenta/o adicciones:{datosSalud.adictionsDetail}</h4>
            </div>
          ) : null}
